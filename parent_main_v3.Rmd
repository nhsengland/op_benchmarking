...
speciality_names <- as.list(unique(all_metrics$speciality))
...
out = c(out, knitr::knit_child('RScripts\\child_metrics_v3.Rmd',envir = metric_env))  
...
out = c(out, knitr::knit_child('RScripts\\child_specs_v3.Rmd',envir = spec_env))
